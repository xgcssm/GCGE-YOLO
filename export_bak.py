...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'PT/16.weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--optimize', action='store_false', help='TorchScript: optimize for mobile')
    parser.add_argument('--int8', action='store_true', help='CoreML/TF INT8 quantization')
    parser.add_argument('--dynamic', action='store_false', help='ONNX/TF: dynamic axes')
